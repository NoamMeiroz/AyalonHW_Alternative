...
db.employer.hasMany(db.employerSites, {
  foreignKey: "EMPLOYER_ID",
  as: "Sites"
});
db.employerSites.belongsTo(db.employer, {
  foreignKey: "EMPLOYER_ID",
  as: 'employer'
});
db.employer.hasMany(db.employee, {
  foreignKey: "EMPLOYER_ID",
  as: "Employees"
});
db.employee.belongsTo(db.employer, {
  foreignKey: "EMPLOYER_ID",
  as: 'employer'
});
db.employee.belongsTo(db.employerSites, {
  foreignKey: "WORK_SITE",
  as: 'Site'
});
module.exports = db;